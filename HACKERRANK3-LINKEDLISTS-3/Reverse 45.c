...
In each query, you will be provided with a string, your task is to delete the given string from the doubly linked list. After performing all the queries,
 your task is print the final Doubly linked list.*/
 #include <stdio.h>
#include <string.h>
#include <math.h>
#include <stdlib.h>
